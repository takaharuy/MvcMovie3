    ...
    public static class DbInitializer
    {
        public static void Initialize(SchoolContext context)
        {
            ...
            var students = new Student[]
            {
                ...
                new Student{FirstMidName="Merdith",LastName="Alonso",EnrollmentDate=DateTime.Parse("2002-09-01")},
                new Student{FirstMidName="Arturo",LastName="Anand",EnrollmentDate=DateTime.Parse("2003-09-01")},
                new Student{FirstMidName="Gytis",LastName="Bazdukas",EnrollmentDate=DateTime.Parse("2002-09-01")},
            ...
            var courseInstructors = new CourseAssignment[]
            {
                ...
                InstructorId=instructors.Single(i => i.LastName=="Zheng").Id},
                new CourseAssignment{CourseId=courses.Single(c => c.Title=="Calcuaus").CourseId,
                InstructorId=instructors.Single(i => i.LastName=="Fakhouri").Id},
            ...
            var enrollments = new Enrollment[]
            {
                ...
                CourseId=courses.Single(c => c.Title=="Calcuaus").CourseId,Grade=Grade.B},
                new Enrollment{StudentId=students.Single(s => s.LastName=="Alonso").Id,
                ...
                new Enrollment{StudentId=students.Single(s => s.LastName=="Bazdukas").Id,
                CourseId=courses.Single(c => c.Title=="Microeconomics").CourseId,Grade=Grade.F},
                ...
                CourseId=courses.Single(c => c.Title=="Calcuaus").CourseId},
                new Enrollment{StudentId=students.Single(s => s.LastName=="Norman").Id,
                CourseId=courses.Single(c => c.Title=="Trigonometry").CourseId,Grade=Grade.A}
            };
